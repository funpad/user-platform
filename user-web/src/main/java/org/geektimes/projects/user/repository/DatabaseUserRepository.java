...
public class DatabaseUserRepository implements UserRepository {
    ...
    public boolean save(User user) {
        ...
        try {
            PreparedStatement ps = connection.prepareStatement(INSERT_USER_DML_SQL);
    ...
    public User getByNameAndPassword(String userName, String password) {
        return executeQuery(QUERY_ALL_USERS_DML_SQL + " WHERE name=? and password=?",
                resultSet -> {
                    // TODO
                    return new User();
     ...
     * @return
     */
    protected <R> R executeQuery(String sql, ThrowableFunction<ResultSet, R> function,
